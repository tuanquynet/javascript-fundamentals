...
ssh -i $SSH_KEY_FILE_PEM -p $PORT pi@$TARGET_SERVER "mkdir -p /home/pi/apps/js-fundamentals"
rsync -avzh --progress -e "ssh -i $SSH_KEY_FILE_PEM -p $PORT" $PACKAGE pi@$TARGET_SERVER:/home/pi/apps/js-fundamentals
